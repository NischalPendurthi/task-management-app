  ...
  return (
    (<div className="flex flex-col h-full">
            ...
            <CardContent>
              <div className="grid grid-cols-4 gap-4">
                <div className="col-span-1 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-2">Tasks that are not started yet.</p>
                </div>
                <div className="col-span-1 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-2">Tasks that are currently being worked on.</p>
                </div>
                <div className="col-span-1 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-2">Tasks that have been finished.</p>
                </div>
                <div className="col-span-1 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-2">Tasks that have missed their due date.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Finalize marketing strategy</TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Onboard new team member</TableCell>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">
                      You have been assigned a new task: Finalize marketing strategy
                    </p>
                ...
                <div className="flex items-start gap-4">
                  <div
                    className="bg-yellow-500 rounded-full w-10 h-10 flex items-center justify-center text-white">
      ...
      <footer
        ...
        <p className="text-sm text-gray-400">© 2024 Task Manager. All rights reserved.</p>
      </footer>
    </div>)
  );
}
